...
interface IExecutorBase {
     ...
     **/
    event GracePeriodUpdate(
        uint256 previousGracePeriod,
     ...
     **/
    event MinimumDelayUpdate(
        uint256 previousMinimumDelay,
     ...
     **/
    event MaximumDelayUpdate(
        uint256 previousMaximumDelay,
        uint256 newMaximumDelay
    );
